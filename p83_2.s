...
stwio r3, 0(sp) # save the value of b onto the top of the stack
stwio r4, 4(sp) # save the value of c in the 2nd position of the stack
mult_LOOP:
...
ldwio r3, 0(sp) # restore b value from top of stack
ldwio r4, 4(sp) # similarly restore a value
addi sp, sp, 8 # remove the 2 stored elements
