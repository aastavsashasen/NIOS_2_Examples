...
.global _start
_start:
#NOTE: sp = r17 and (sp) = (r27)
# assign an initial value to r10
movi r10, 0x02
# here is how a push can be implemented
subi sp, sp, 4  # grow the stack by four bytes (a long word)
stwio r10, 0(sp) # save the value of r10 onto the top of the stack
# here is how a pop can be implemented
ldwio r11, 0(sp) # read the top value of the stack
addi sp, sp, 4 # incr the stack pointer thus removing the top element
.end 
