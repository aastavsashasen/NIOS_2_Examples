...
movi r5, 10   		 # number of memory locations
movi r6, 1    		 # constant = 1
main_loop:
ldw r7, (r3)		#load the value of the address in r3 into r7 
beq r7, r6, Mul_By_2     	# branch to Mul_By_2 if r7 is 1
muli r7, r7, 0x5           	# multiply by 5 
store:	
stw r7, (r4) 		#store value of register in address r4
addi r3, r3, 0x01   		# increment r3
addi r4, r3, 0x01  		# increment r4
